...
import com.kenny2810.CheeseAndCrackers.Entities.EntityCracker;
	...
	public class CloudyCracker extends Item
	{
		public static String modid="CheeseAndCrackers";
	    public CloudyCracker()
	    {
	        super();
	    ...
	    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
	    {
	    	...
	    	ItemStack crackerCStack = new ItemStack(CheeseAndCrackersMain.CloudyCracker);
	    ...
	    player.addPotionEffect((new PotionEffect(Potion.waterBreathing.getId(), 1, 4)));
