...
import com.kenny2810.CheeseAndCrackers.Entities.EntityCracker;
	...
	public class LisasCracker extends Item
	{
	    ...
	    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
	    {
	    	...
	    	ItemStack crackerStack = new ItemStack(CheeseAndCrackersMain.LisasCracker);
	    ...
	    public boolean hitEntity(ItemStack stack, EntityLivingBase hitEntity, EntityLivingBase attackingEntity) {
	            hitEntity.addPotionEffect((new PotionEffect(Potion.wither.getId(), 200, 1)));
	            hitEntity.setFire(4);
	            return true;
	    }
	}
