...
import com.kenny2810.CheeseAndCrackers.Entities.EntityCracker;
	...
	public class LisasCheese extends Item
	{
		public static String modid="CheeseAndCrackers";
	    public LisasCheese()
	    {
	        super();
	        setUnlocalizedName("Lisa`s Cheese");
	    ...
	    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
	    {
	    	...
	    	ItemStack crackerStack = new ItemStack(CheeseAndCrackersMain.LisasCheese);
	    ...
	    player.addPotionEffect((new PotionEffect(Potion.fireResistance.getId(), 1, 4)));
